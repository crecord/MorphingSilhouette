...
void ofxPolylineMerger::mergePolyline(float interpolationCoeff,float amntOfNoise, float speed){
    polyOut.clear();
...
void ofxPolylineMerger::mergePolyline(ofPolyline &p1, ofPolyline &p2, float interpolationCoeff, float amntOfNoise, float speed){
    
    setPoly1(p1);
    setPoly2(p2);
    
    mergePolyline(interpolationCoeff, amntOfNoise, speed);
}